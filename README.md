...
<a href="docs/onepagers/findings.en.pdf"><img src="docs/onepagers/findings.en-hero.png" width="100%" alt="Business one-pager — Retention, not price"></a>

**Technical brief** ([`method.en.pdf`](docs/onepagers/method.en.pdf)):

<a href="docs/onepagers/method.en.pdf"><img src="docs/onepagers/method.en-hero.png" width="100%" alt="Technical one-pager — Numbers by code, story by agent"></a>
